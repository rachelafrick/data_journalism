...
function analysis() {
	...
	if(mdata[indexx].uninsured<mdata[0].uninsured){
		document.getElementById("analysis").innerText="The data for " + mdata[indexx].location + " shows that the majority of people in " + mdata[indexx].location + " recieve insurance through their employer. " + mdata[indexx].uninsured.toFixed(3)*100 + " percent of the population of " + mdata[indexx].location + " is uninsured. This number is less then the national average, " + mdata[0].uninsured*100 + " percent, meaning "  + mdata[indexx].location + " has a higher health care coverage rate than the U.S. as a whole." ;
	}
